...
class HangingProtocolService {
  ...
  private _validateRequiredSelectors(
    ...
    //alert('validateRequiredSelectors'); //Ali

    const { seriesMatchingRules } = displaySetSelector;

    //alert(seriesMatchingRules + '|seriesMatchingRules'); //Ali
    ...
    if (seriesMatchingRules.length) {
      ...
      //alert(seriesMatchingRules.length + '|seriesMatchingRules.length|'); //ALi
      //alert(requiredRules + '|rule|'); //ALi
      //alert(displaySet + '|displaySet|'); //ALi

      const matched = this.protocolEngine.findMatch(displaySet, requiredRules);

      //alert(matched + '|matched'); //ALi commented below lines
